...
?>
    ...
    <h2>Voting Candidates Info</h2>
    
    <h1><?php echo $productInfo['name'] ?><h1>
    <img width="200" height="200" alt="Product Demo" src="<?php echo $productInfo['image'] ?>">
    <h4>Votes: <?php echo $productInfo['price'] ?></h4>
    <h4>Maximum Votes:<?php echo ($bidInfo['bid_amount']) ? $bidInfo['bid_amount'] : 0; ?></h4>
    <h4>Voter Name: <?php echo ($customerInfo['name']) ? $customerInfo['name'] : 'None'; ?></h4>
    <h4>Voter Email: <?php echo ($customerInfo['email']) ? $customerInfo['email'] : 'None'; ?></h4>
